    ...
    render() {
        ...
        return (
            <div style={{position: 'relative', width: '100%'}}>
                ...
                <HorizontalScrollContainer justifyContent={(scrollWidth > offsetWidth)? 'flex-start' : 'center'} innerRef={this.horizontalScroller}>
                    {this.props.children}
                </HorizontalScrollContainer>

                <TransparentButton position="absolute" style={{
                    top: 0, right: 0, border: 0,outline:'none'
                }} onClick={this.scrollRight}><img
